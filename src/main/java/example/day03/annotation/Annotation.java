...
class SubClass extends SuperClass{ // 하위 클래스
    ...
    @Deprecated void metohd2() { } // 더이상 사용하지 않는 메소드 알리는 어노테이션
}
// [어노테이션] : 인터페이스 기반
...
// [어네토이션 사용하기 ] : 내가 만든 어노테이션 사용
class TestClass{
    @MyAnnotation( value1 = "주입하는 값")
...
public class Annotation {
    public static void main(String[] args) {
        ...
        /*
            ...
            2. 목적: 1>메타데이터제공 2>코드 간소화 3>가독성 향상
            3. 종류
            ...
            4. 어노테이션 만들기
                ...
                2) 인터페이스 위에 실행시점, 실행위치 설정
                    1] @Retention ( RetentionPolicy.RUNTIME ) : 프로그램 실행중 유지 뜻,
                       ...
                       @Retention ( RetentionPolicy.SOURCE ) : 컴파일(코드->번역) 이후에까지만 유지 뜻
             ...
             6. 동적 로딩이란? 리플렉션, 실행 중에 클래스를 읽어와서 객체 생성 과정
